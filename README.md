...
- Cross-check for missing modern entries was done against [boshallen/Awesome-Optimizers](https://github.com/boshallen/Awesome-Optimizers?tab=readme-ov-file#awesome-optimizers), [AidinHamedi/Optimizer-Benchmark](https://github.com/AidinHamedi/Optimizer-Benchmark), and [Benchmarking Optimizers for Large Language Model Pretraining](https://arxiv.org/abs/2509.01440).
